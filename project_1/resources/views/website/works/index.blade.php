<!DOCTYPE html>
<html lang="en">
<!-- التحكم بصفحة الاعمال الي فيها الصور الشخصية للفنانين-->
<head>
    <meta charset="UTF-8">
                            ...
                            <div class="row">
                                ...
                                @foreach($works as $work)
                                    <div class="col-sm-4">
                                        ...
                                        <a href="{{ route('showWork' , ['id' => $work->id]) }}" title="" class="btn btn-default" style="margin-left: 110px;">My Artwork</a>
...
<footer class="footer-container text-center">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <p> Website created with Artistoria</p>
            </div>
        </div>
    </div>
</footer>
