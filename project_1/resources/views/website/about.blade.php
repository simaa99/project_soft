                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                ...
                                <p>In Palestine there are many artists, not famous, so we thought of creating a website that provides artistic services in one place.
                            ...
                            <div class="col-xs-12 col-md-6">
                                <img src="https://mrkzgulfup.com/uploads/162530973652481.jpg" class="img-responsive" alt="">
                            </div>
                        </div>
                    </div>
                </div>
