var Login = function () {
    ...
    return {
        init: function () {
            e(), r(), s(), $.backstretch(["../assets/admin/assets/pages/media/bg/1.jpg", "../assets/admin/assets/pages/media/bg/2.jpg", "../assets/admin/assets/pages/media/bg/3.jpg", "../assets/admin/assets/pages/media/bg/4.jpg"], {
                fade: 1e3,
                duration: 8e3
            })
        }
