var hobbies_tbl = $("#hobbies_tbl");
$(document).ready(function () {


    if ($("#hobbies_tbl").length) {

        hobbies_tbl.on('preXhr.dt', function (e, settings, data) {
            // data.username = $('#username_c').val();
        }).dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                url: baseURL + "/constants/hobby-data",
