var managerMessages_tbl = $("#managerMessages_tbl");
$(document).ready(function () {


    if ($("#managerMessages_tbl").length) {

        managerMessages_tbl.on('preXhr.dt', function (e, settings, data) {
            // data.username = $('#username_c').val();
        }).dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                url: baseURL + "/managerMessages/managerMessage-data",
    ...
    $(document).on("click", ".filter-submit", function () {
        managerMessages_tbl.api().ajax.reload();
    });
