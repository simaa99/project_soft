var subscriptions_tbl = $("#subscriptions_tbl");
$(document).ready(function () {


    if ($("#subscriptions_tbl").length) {

        subscriptions_tbl.on('preXhr.dt', function (e, settings, data) {
            // data.username = $('#username_c').val();
        }).dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                url: baseURL + "/constants/subscription-data",
                "dataSrc": function (json) {
                    //Make your callback here.
                    if (json.status !== undefined && !json.status) {
                        $('#subscriptions_tbl_processing').hide();
                        location.reload();
                        //
                    } else
                        return json.data;
    ...
    $(document).on("click", ".filter-submit", function () {
        subscriptions_tbl.api().ajax.reload();
    });
