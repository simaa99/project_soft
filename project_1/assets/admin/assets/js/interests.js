var interests_tbl = $("#interests_tbl");
$(document).ready(function () {


    if ($("#interests_tbl").length) {

        interests_tbl.on('preXhr.dt', function (e, settings, data) {
            // data.username = $('#username_c').val();
        }).dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                url: baseURL + "/constants/interest-data",
                "dataSrc": function (json) {
                    //Make your callback here.
                    if (json.status !== undefined && !json.status) {
                        $('#interests_tbl_processing').hide();
                        location.reload();
                        //
                    } else
                        return json.data;
