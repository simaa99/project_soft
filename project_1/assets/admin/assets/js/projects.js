var projects_tbl = $("#projects_tbl");
$(document).ready(function () {


    if ($("#projects_tbl").length) {

        projects_tbl.on('preXhr.dt', function (e, settings, data) {
            // data.username = $('#username_c').val();
        }).dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                url: baseURL + "/projects/project-data",
            ...
            columns: [
                ...
                {data: 'small_image', name: 'small_image'},
    ...
    $(document).on('click', '.delete', function (event) {
        ...
        bootbox.dialog({
            message: "Are you sure ? <span class='label label-danger'> you can not return back!</span>",
