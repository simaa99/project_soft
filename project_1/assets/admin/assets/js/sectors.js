var sectors_tbl = $("#sectors_tbl");
$(document).ready(function () {


    if ($("#sectors_tbl").length) {

        sectors_tbl.on('preXhr.dt', function (e, settings, data) {
            // data.username = $('#username_c').val();
        }).dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                url: baseURL + "/sectors/sector-data",
