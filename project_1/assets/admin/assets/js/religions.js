var religions_tbl = $("#religions_tbl");
$(document).ready(function () {


    if ($("#religions_tbl").length) {

        religions_tbl.on('preXhr.dt', function (e, settings, data) {
            // data.username = $('#username_c').val();
        }).dataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                url: baseURL + "/constants/religion-data",
                "dataSrc": function (json) {
                    //Make your callback here.
                    if (json.status !== undefined && !json.status) {
                        $('#religions_tbl_processing').hide();
                        location.reload();
                        //
                    } else
                        return json.data;
